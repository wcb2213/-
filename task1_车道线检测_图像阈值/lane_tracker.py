...
class LaneTracker:
    ...
    def apply_lines(self, img):
        ...
        mag_binary = mag_thresh(img, sobel_kernel=3, thresh=(25, 255))
        # dir_binary = dir_thresh(img, sobel_kernel=15, thresh=(0.7, 1.3))
        dir_binary = dir_thresh(img, sobel_kernel=15, thresh=(0.8, 1.4))
        grad_binary[((mag_binary == 1) & (dir_binary == 1))] = 1

        # Threshold color
        # color_binary = color_thresh(img, r_thresh=(220, 255), s_thresh=(150, 255))
        color_binary = color_thresh(img, r_thresh=(145, 255), s_thresh=(50, 255))
